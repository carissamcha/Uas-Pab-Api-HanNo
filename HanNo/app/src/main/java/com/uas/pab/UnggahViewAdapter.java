...
import com.uas.pab.databinding.ItemUnggahBinding;
...
public class UnggahViewAdapter extends RecyclerView.Adapter<UnggahViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemUnggahBinding.tvUsername.setText(unggah.getAlbum()); // Update this line
        holder.itemUnggahBinding.tvContent.setText(unggah.getContent());
        holder.itemUnggahBinding.tvCreatedDate.setText(unggah.getTahun());
